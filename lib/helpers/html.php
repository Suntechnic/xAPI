...
namespace X\Helpers
{
    class Html
    {
        ...
        */
         ...
         * Удаляются все символы не являющиеся цифрами
         * Если задана длина телефононго номера и номер не соотвествует ей - возвращается false
         * В случае если соотвествует и производится замена начального кода согласна содержимому массива $coder
